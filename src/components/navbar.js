...
export function renderNavbar(state) {
  ...
  el.innerHTML = `
    <div class="nav-inner max-w-[1320px] mx-auto px-4 py-3.5 flex items-center gap-4 flex-wrap md:px-8 md:gap-6 md:flex-nowrap">
      ...
      <div class="nav-links flex gap-1 ml-0 flex-wrap md:ml-3 md:flex-nowrap">
      ...
      <div class="nav-meta ml-auto flex gap-3.5 items-center font-mono text-[10.5px] tracking-[.14em] uppercase text-ink-mute flex-wrap">
        <label class="keymap-toggle inline-flex items-center gap-2 py-0.5 pl-3 pr-1 border border-rule rounded-sm bg-paper-deep text-ink-soft font-mono text-[10.5px] tracking-[.18em] uppercase" title="Keyboard mode">
        ...
        <button class="${BTN} nav-req-btn" id="navRequestsBtn" title="Edit requests">
          Edit reqs
